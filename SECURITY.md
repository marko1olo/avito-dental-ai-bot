...
We actively maintain and provide security patches for the following versions of **marko1olo/avito-dental-ai-bot**:
...
Security audits for **marko1olo/avito-dental-ai-bot** focus on the following attack surfaces and failure modes:

1. **Prompt Injection / Jailbreaks**:  Adversarial user messages attempting to extract system prompts or discount codes.
2. **Unauthorized Booking Mutation**:  Forged webhook requests creating phantom dental appointments.
3. **Credential Leakage**:  Exposure of Avito API keys or PostgreSQL connection strings.

---

## 🚨 3. Reporting a Vulnerability

If you discover a security vulnerability or exploit in **marko1olo/avito-dental-ai-bot**, please report it responsibly:
