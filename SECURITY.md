# 🔒 Security Policy — marko1olo/avito-dental-ai-bot
...
> Project Scope: `Avito Dental AI Bot 4-Stage Veto Pipeline & Lead Converter`
...
We actively maintain and provide critical security updates for the following release lines of **marko1olo/avito-dental-ai-bot**:
...
Security engineering in marko1olo/avito-dental-ai-bot is guided by the following domain-specific threat vector analyses:

### 1. Prompt Injection / Jailbreaks
* **Description**: Adversarial user messages attempting to extract system prompts or discount codes.
...
### 2. Unauthorized Booking Mutation
* **Description**: Forged webhook requests creating phantom dental appointments.
* **Impact Rating**: HIGH / CRITICAL
* **Mitigation Strategy**: Strict schema validation, boundary fuzz testing, and automated static security analysis.
### 3. Credential Leakage
* **Description**: Exposure of Avito API keys or PostgreSQL connection strings.
* **Impact Rating**: HIGH / CRITICAL
* **Mitigation Strategy**: Strict schema validation, boundary fuzz testing, and automated static security analysis.
...
If you discover a security flaw or exploit vector in **marko1olo/avito-dental-ai-bot**, do **NOT** post it publicly in open issues or discussions.
